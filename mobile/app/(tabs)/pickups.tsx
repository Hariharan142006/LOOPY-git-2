                ...
                {selectedTask ? (
                    <Animated.View entering={SlideInDown} style={styles.taskCard}>
                        ...
                        <View style={{ marginBottom: Spacing.lg }}>
                            <Text style={{ fontSize: FontSizes.xs, fontWeight: '800', color: LoopyColors.grey, textTransform: 'uppercase', marginBottom: Spacing.xs }}>Pickup Address</Text>
...
const styles = StyleSheet.create({
    ...
    map: { flex: 1 },
    overlay: { position: 'absolute', bottom: Platform.OS === 'ios' ? 100 : 30, left: 16, right: 16, gap: Spacing.lg },
    refreshBtn: { alignSelf: 'flex-end', width: 44, height: 44, borderRadius: BorderRadius.lg, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center', elevation: 5, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 5 },
    ...
    markerText: { color: '#fff', fontSize: FontSizes.sm, fontWeight: 'bold' },
    taskCard: { backgroundColor: '#fff', borderRadius: 28, padding: Spacing.xl, elevation: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.15, shadowRadius: 20 },
    cardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 10 },
    customerName: { fontSize: FontSizes.xl, fontWeight: '800', color: LoopyColors.charcoal },
    taskStatus: { fontSize: 11, fontWeight: '700', color: LoopyColors.green, textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 2 },
    addressText: { fontSize: FontSizes.md, color: LoopyColors.grey, marginBottom: Spacing.lg },
    cardActions: { flexDirection: 'row', gap: Spacing.md },
    primaryBtn: { flex: 1, flexDirection: 'row', backgroundColor: LoopyColors.charcoal, borderRadius: BorderRadius.xl, paddingVertical: 14, alignItems: 'center', justifyContent: 'center', gap: Spacing.sm },
    secondaryBtn: { width: 54, height: 54, borderRadius: BorderRadius.xl, backgroundColor: LoopyColors.lightGrey, alignItems: 'center', justifyContent: 'center' },
    ...
    summaryVal: { fontSize: FontSizes['2xl'], fontWeight: '900', color: LoopyColors.charcoal },
    summaryLabel: { fontSize: 11, color: LoopyColors.grey, fontWeight: '600', marginTop: 2 },
    summaryDivider: { width: 1, height: 30, backgroundColor: LoopyColors.border }
});
