...
export default function ReferEarnScreen() {
  ...
  const onShare = async (code: string, reward: number) => {
    try {
      await Share.share({
        message: `Join me on Loopy! Use my code ${code} to get ₹${reward} discount on your first pickup. Download it now!`,
      });
    } catch (error) {
      console.error(error);
    }
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        <Animated.View entering={FadeInUp} style={styles.heroCard}>
          ...
          <Text style={styles.heroSub}>Give your friends a discount and get rewarded for every successful pickup they complete.</Text>
        </Animated.View>
        ...
        {loading ? (
          ...
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySub}>Check back later for new referral rewards!</Text>
          </View>
        ) : (
            ...
            <Animated.View key={reward.id} entering={FadeInDown.delay(idx * 100)} style={styles.rewardCard}>
              <View style={styles.codeSection}>
                <View style={styles.labelRow}>
                  <Text style={styles.label}>Promotional Reward</Text>
        ...
        <View style={styles.howItWorks}>
          ...
          <View style={styles.step}>
            ...
            <Text style={styles.stepText}>Share a promotional code with friends.</Text>
          </View>
          <View style={styles.step}>
            <View style={styles.stepNum}><Text style={styles.stepNumText}>2</Text></View>
            <Text style={styles.stepText}>They enter the code on signup and book their first pickup.</Text>
          </View>
          <View style={styles.step}>
            <View style={styles.stepNum}><Text style={styles.stepNumText}>3</Text></View>
            <Text style={styles.stepText}>You Both get rewards in your wallets when they finish!</Text>
          </View>
        </View>
      </ScrollView>
    </View>
